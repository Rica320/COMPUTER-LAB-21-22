 ...
 *
 * Enables stream mode data reporting, by sending the respective command to the
 * mouse.
 *
 * This function is provided by the LCF.
 *
 * In order to score points for your Lab 4 grade, you should implement this
 * functionality yourself. * This can be done by defining your own function with
 * the same functionality, or just by adding this functionality somewhere in
 * your code.
 *
