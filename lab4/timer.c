...
int (timer_subscribe)(int *bit_no) {
  hook_id = *bit_no;        //hook_id vai ser o valor que est� no endere�o passado como argumento
  sys_irqsetpolicy(TIMER0_IRQ, IRQ_REENABLE, &hook_id); //subscreve uma interrup��o, ativando a IRQ LINE do timer com o hook_id dado
  return 0;
}
